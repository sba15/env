...
// const Footer = () => {
//   return (
//     <footer className="relative text-black py-10 w-full bg-cover bg-center" style={{ backgroundImage: `url(${Home19})` }}>
//       <div className="absolute inset-0 bg-black bg-opacity-30"></div>

//       <div className="relative z-10 mx-9 grid grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-8 px-2 sm:px-4 text-white">
//         <div>
//           <h6 className="font-bold mb-2">About Us</h6>
//           <ul className="space-y-2">
//             <li>SBA Info Solution</li>
...
//       <div className="relative z-10 flex flex-col md:flex-row justify-between items-center mt-8 px-2 sm:px-4 text-white">
//         <div className="text-center md:text-left">
//           <p className="text-sm">
//             Phone: +91 44 24897598, +91 44 24894657
//           </p>
...
//       <div className="relative z-10 text-center mt-8 text-sm text-gray-300 px-2 sm:px-4">
//         <p>&copy; 1996 - 2024, SBA Info Solutions.</p>
//       </div>
//     </footer>
//   );
...
const Footer = () => {
  return (
    <footer
      className="relative text-black py-10 w-full bg-cover bg-center"
      style={{ backgroundImage: `url(${Home19})` }}
    >
      <div className="relative z-10 mx-9 grid grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-8 px-2 sm:px-4 text-black">
        <div>
          <h6 className="font-bold mb-2">About Us</h6>
          <ul className="space-y-2">
            <li>SBA Info Solution</li>
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-center mt-8 px-2 sm:px-4 text-black">
        <div className="text-center md:text-left">
          <p className="text-sm">Phone: +91 44 24897598, +91 44 24894657</p>
          <p className="text-sm">Email: sales@sbainfo.in</p>
        </div>
        <div className="flex justify-center md:justify-end mt-4 md:mt-0 space-x-4">
          <a href="#" className="text-blue-500">
            <i className="fab fa-linkedin"></i>
